...
function config(options) {
    return async function (tree, context) {
        ...
        (0, dependencies_1.addPackageJsonDependency)(tree, {
            ...
            type: dependencies_1.NodeDependencyType.Default,
            version: (0, dependencies_1.getPackageJsonDependency)(tree, '@angular/core')?.version || 'latest',
            overwrite: false,
        });
        (0, dependencies_1.addPackageJsonDependency)(tree, {
            name: '@angular-devkit/build-angular',
            type: dependencies_1.NodeDependencyType.Dev,
            version: (0, dependencies_1.getPackageJsonDependency)(tree, '@angular/build')?.version || 'latest',
            overwrite: false,
        });
        (0, dependencies_1.addPackageJsonDependency)(tree, {
    ...
    for (const p in workspace.projects) {
        ...
        if (p !== projectName &&
            ...
            const pPort = project.architect['serve-original']?.options?.port ??
                ...
                4200;
            result[core_1.strings.camelize(p)] =
