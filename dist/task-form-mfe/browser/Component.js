...
function TaskFormComponent_div_21_Template(rf, ctx) {
  if (rf & 1) {
    i0.\u0275\u0275elementStart(0, "div", 11);
    i0.\u0275\u0275text(1, " Entry has been recorded! ");
    i0.\u0275\u0275elementEnd();
  }
}
var TaskFormComponent = class _TaskFormComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ i0.\u0275\u0275defineComponent({ type: _TaskFormComponent, selectors: [["task-form"]], decls: 22, vars: 4, consts: [[1, "registry-container"], [1, "registry-header"], [1, "list-body"], [1, "form-group"], ["placeholder", "Enter a brief description here!", 1, "dark-input", 3, "ngModelChange", "ngModel"], [1, "dark-select", 3, "ngModelChange", "ngModel", "ngClass"], ["value", "Low"], ["value", "Medium"], ["value", "High"], [1, "submit-btn", 3, "click"], ["class", "toast-message", 4, "ngIf"], [1, "toast-message"]], template: function TaskFormComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      i0.\u0275\u0275listener("click", function TaskFormComponent_Template_button_click_19_listener() {
        return ctx.onSubmit();
      });
      i0.\u0275\u0275text(20, "Record Task");
      i0.\u0275\u0275elementEnd()()();
      i0.\u0275\u0275template(21, TaskFormComponent_div_21_Template, 2, 0, "div", 10);
      i0.\u0275\u0275elementEnd();
    }
    if (rf & 2) {
      i0.\u0275\u0275advance(7);
